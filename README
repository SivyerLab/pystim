...
Stimulus Program uses the Psychopy library to create various visual stimuli
for use with on patch clamp retinal cells. It comes with a GUI for ease of
use. The program is capable of running at 60 fps and triggering recording
devices (using a LabJack U3).
...
Stimulus Program is licensed under GNU GPL v3.0. See [LICENSE](LICENSE.txt)
